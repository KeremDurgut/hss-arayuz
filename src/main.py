...
from ui.arayuz_ui import Ui_CelikkubbeUI
from ui.kamera_modulu import KameraThread  # Yeni yazdığımız modülü içe aktarıyoruz
...
if __name__ == '__main__':
    ...
    qss_yolu = os.path.join(os.path.dirname(__file__), "styles", "style.qss")
